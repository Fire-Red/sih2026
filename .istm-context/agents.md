...
Visible pages must use neutral location language. Do not expose internal pilot names, regional labels, competition references, or implementation identifiers in public interface copy.
...
DONT Mention sih anyhwer no eybeors in ui and stuff keep it minal and good 
