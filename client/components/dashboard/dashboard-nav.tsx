...
export function DashboardNav({ session }: DashboardNavProps) {
  ...
  return (
    <header className="h-16 border-b border-border bg-background sticky top-0 z-30 px-4 sm:px-8 flex items-center justify-between">
      <div className="flex items-center gap-6">
        <Link href="/" className="flex items-center gap-2 group">
          <span className="w-5 h-5 rounded-full bg-primary inline-flex items-center justify-center transition-transform group-hover:scale-105">
            <span className="text-primary-foreground text-[9px] font-semibold">C</span>
          </span>
        ...
        <div className="hidden md:flex items-center gap-4 pl-6 border-l border-border">
          ...
          <span className="text-xs px-2.5 py-1 rounded-full bg-muted border border-border font-medium text-foreground">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 pr-3 border-r border-border">
          <div className="w-8 h-8 rounded-full bg-muted border border-border flex items-center justify-center text-xs font-medium text-foreground">
