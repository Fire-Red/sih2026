...
export function ProfileSettings({ session }: ProfileSettingsProps) {
  ...
  useEffect(() => {
    ...
    } else if (profile.role === "industry" && roleProfile && "organizationName" in roleProfile) {
      const industryProfile = roleProfile as IndustryProfileData;
      startTransition(() => {
        setOrganization(industryProfile.organizationName);
        setDepartment(industryProfile.csrFocus || "");
        setDesignation(industryProfile.contactPersonDesignation || "");
      });
    }
  ...
  const saveProfile = async () => {
    ...
    if (profile.role === "industry") roleProfile = { organizationName: organization, csrFocus: department, contactPersonDesignation: designation };
